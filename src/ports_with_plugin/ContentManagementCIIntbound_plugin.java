...
public class ContentManagementCIIntbound_plugin  extends AbstractInboundPort  implements  ContentManagementCI {

	public ContentManagementCIIntbound_plugin(ComponentI owner ,String plugin)
			throws Exception {
