...
public class FacadeContentManagementCInbound_plugin extends AbstractInboundPort implements  FacadeContentManagementCI {
	public FacadeContentManagementCInbound_plugin(String pluginURI ,ComponentI owner)
			throws Exception {
